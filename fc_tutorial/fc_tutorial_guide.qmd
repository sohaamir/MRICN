...
You can have a look at the script yourself by typing `nano run_bash.sh`.
...
on GitHub @sohaamir and on Twitter @AamirNSohail (not part of the module).
...
should have loaded up but is blocking the voxels. Change the Opacity to about half-way. 
